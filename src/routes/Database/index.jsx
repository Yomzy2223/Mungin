...
const Database = () => {
  ...
  // const [crops, setcrops] = useState([
  //   { id: 11, name: "Maize", year: 2021, version: "Original" },
  //   { id: 12, name: "Maize", year: 2021, version: "Original" },
  //   { id: 13, name: "Maize", year: 2021, version: "Original" },
  //   { id: 14, name: "Maize", year: 2021, version: "Original" },
  //   { id: 15, name: "Maize", year: 2021, version: "Original" },
  // ]);

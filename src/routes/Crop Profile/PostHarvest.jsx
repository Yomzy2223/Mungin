    ...
    return (
        ...
        <div className='flex'>
            ...
            <div className='mt-10 flex w-full flex-col'>
                ...
                {/* content */}
                <div className='m-8'>
                <h2 className='text-2xl font-semibold'>The Post Harvest Operations of Maize Include:</h2>
                ...
                <div className='m-4 flex'>
                    {/* green tick */}
                    <div className='px-2'><img src={circle} alt='circle' width={25}/></div>
                    <p className='text-[#565656] font-semibold'>Grading/Sorting/Packaging</p>
                </div>
                {/* cultivar container 1 */}
                <div className='m-4 flex'>
                    {/* green tick */}
                    <div className='px-2'><img src={circle} alt='circle' width={25}/></div>
                    <p className='text-[#565656] font-semibold'>Transportation/Loading & Unloading</p>
                </div>
                {/* cultivar container 1 */}
                <div className='m-4 flex'>
                    {/* green tick */}
